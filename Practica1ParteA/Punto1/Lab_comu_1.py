...
class Lab_comu_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "punto_5", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("punto_5")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab_comu_1")
        ...
        self._samp_rate_range = qtgui.Range(1e3, 80e3, 1e3, 10e3, 200)
        ...
        self._freq_range = qtgui.Range(1e3, 80e3, 1e3, 2e3, 200)
        self._freq_win = qtgui.RangeWidget(self._freq_range, self.set_freq, "frecuency", "counter_slider", float, QtCore.Qt.Horizontal)
